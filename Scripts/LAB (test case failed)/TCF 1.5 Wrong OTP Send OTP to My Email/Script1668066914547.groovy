...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_/SendEmail_login-otp-mh360-image'), 5)

'"OTP" page'
WebUI.takeFullPageScreenshotAsCheckpoint('OTP page')

'Scroll find area "Send OTP to my email" link'
WebUI.scrollToElement(findTestObject('Object Repository/Page_/SendEmail_div-OTP-to-my-email'), 1)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_/Email_otp-mh360-image'), 5)

'"OTP" by email page'
WebUI.takeFullPageScreenshotAsCheckpoint('OTP page by Email')

'Scroll find area "OTP" field'
WebUI.scrollToElement(findTestObject('Object Repository/Page_/Email_div-otp-field'), 1)
...
'Enter "OTP" code'
WebUI.setText(findTestObject('Object Repository/Page_/Email_otp-field'), '123455')
...
'Scroll find area "Error message" invalid OTP'
WebUI.scrollToElement(findTestObject('Object Repository/Page_/div_Incorrect Email OTP, please try again'), 1)

'"Error message" invalid OTP'
WebUI.takeElementScreenshot(findTestObject('Object Repository/Page_/div_Incorrect Email OTP, please try again'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_/li_Incorrect Email OTP, please try again'), 10)

'Enter "OTP" code'
WebUI.setText(findTestObject('Object Repository/Page_/Email_otp-field'), '123455')

'"OTP page invalid otp code"'
